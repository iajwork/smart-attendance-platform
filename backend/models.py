...
class ClockLogs(Base):
    ...
    location_status = Column(String(255)) # <--- This is the line Python was missing!
    device_identifier = Column(String(255))
    address = Column(Text)
...
class MonthlySummary(Base):
    ...
    invalid_days = Column(Integer, default=0)  # <--- NEW COLUMN ADDED HERE
